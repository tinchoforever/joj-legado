...
d3.csv("legado.csv", function( baseL ) {
	...
	var infoBox = node.append('foreignObject').classed('circle-overlay hidden', true).attr('x', infoboxX * 0.5 * 0.8).attr('y', infoboxY* 0.66 * 0.75).attr('height', 520 ).attr('width', 350 * 0.95).append('xhtml:div').classed('circle-overlay__inner', true);
